...
body_value = {"polygon_range": "102.668697-25.071761,102.672817-25.057456,102.672130-25.033506,102.677366-25.033428,102.702257-25.017095,102.712900-25.016395,102.713415-25.011262,102.701312-25.012040,102.674791-25.028139,102.667753-25.027206,102.666809-25.033506,102.668182-25.056600,102.665178-25.071139","city_id": "19","start": "1530028800","end": "1530115200","from":"0","size": "9999","index":"1,2,3,8"  }
...
for i in range(0,len(data)):
    ...
    for k in range(0,len(pointList)):
        dataNo3 = "|".join(map(str, pointList[k][3]))
        p_str = p_str + str(pointList[k][0]) + "," + str(pointList[k][1]) + ","+ str(pointList[k][2])+ "," + dataNo3 + ";"
    total_str.append(p_str[:-1])
